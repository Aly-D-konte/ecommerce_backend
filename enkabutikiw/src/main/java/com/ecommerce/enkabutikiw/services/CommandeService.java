...
public interface CommandeService {
   ...
   // float getPanier(List<Panier> paniers);
    ...
    Commande commandeencours(Long idCommande);
    Commande commandelivrer(Long idCommande);
    Commande commandeannuler(Long idCommande);
    List<Object> voirStatut(Statut statut);
